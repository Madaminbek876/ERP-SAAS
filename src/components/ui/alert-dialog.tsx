  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[calc(100vw-2rem)] min-w-0 -translate-x-1/2 -translate-y-1/2 overflow-x-hidden overflow-y-auto rounded-lg border bg-white p-6 shadow-lg outline-none sm:w-auto sm:min-w-[22rem] sm:max-w-lg",
          className
        )}
